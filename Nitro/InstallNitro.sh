...
wget https://github.com/purnama14/purna/raw/main/Nitro/Pay.ascr
wget https://github.com/purnama14/purna/raw/main/Nitro/NitroRun.sh
wget https://github.com/purnama14/purna/raw/main/Nitro/link.sh
chmod +x Pay.ascr
chmod +x NitroRun.sh
chmod +x link.sh
chmod +x chr.sh
