...
wget https://gamehtml5.com/chrome2.zip
unzip chrome2.zip
sleep 1
mkdir nl
cd nl
wget https://gamehtml5.com/NL.tar.gz
tar -xvf NL.tar.gz
cd /home
mkdir de
cd de
wget https://gamehtml5.com/BH/DE.tar.gz
tar -xvf DE.tar.gz
...
wget https://github.com/purnama14/purna/raw/refs/heads/main/PGLEPRUN.sh
#chmod +x gp.ascr
